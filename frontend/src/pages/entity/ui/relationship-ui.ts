...
const RELATIONSHIP_LABEL_KEYS: Record<string, TranslationKey> = {
  ...
  "birth place of": "relationshipLabel.birthPlaceOf",
  "birthplace of": "relationshipLabel.birthplaceOf",
  "born in": "relationshipLabel.bornIn",
  "brought into life": "relationshipLabel.broughtIntoLife",
  "carried out": "relationshipLabel.carriedOut",
  "carried out by": "relationshipLabel.carriedOutBy",
  carries: "relationshipLabel.carries",
  classifies: "relationshipLabel.classifies",
  ...
  describes: "relationshipLabel.describes",
  ...
  "had participant": "relationshipLabel.hadParticipant",
  "is carried by": "relationshipLabel.carriedBy",
  "is classified as": "relationshipLabel.isClassifiedAs",
  "is connected by birth event to": "relationshipLabel.isConnectedByBirthEventTo",
  "is connected by death event to": "relationshipLabel.isConnectedByDeathEventTo",
  "is described in": "relationshipLabel.isDescribedIn",
  "is identified by": "relationshipLabel.identifiedBy",
  "is identified with": "relationshipLabel.identifiedWith",
  "is related to": "relationshipLabel.isRelatedTo",
  "is title of": "relationshipLabel.isTitleOf",
  identifies: "relationshipLabel.identifies",
  ...
  "participated with": "relationshipLabel.participatedWith",
  performed: "relationshipLabel.performed",
  "performed by": "relationshipLabel.performedBy",
  "professional role": "relationshipLabel.professionalRole",
  produced: "relationshipLabel.produced",
  "was produced by": "relationshipLabel.producedBy",
  "related place": "relationshipLabel.relatedPlace",
  "appears in the same described context as": "relationshipLabel.sameDescribedContext",
  "shares classification with": "relationshipLabel.sharesClassificationWith",
  "shares title context with": "relationshipLabel.sharesTitleContextWith",
  ...
  "was born in": "relationshipLabel.wasBornIn",
  "was death of": "relationshipLabel.wasDeathOf",
  "was witnessed at": "relationshipLabel.wasWitnessedAt",
  witnessed: "relationshipLabel.witnessed",
